MungCSV = {
	...
	format_parsed_data: function(file_info, parsed_output){
		...
		MungCSV.load_into_collections(file_info, csv_data);
		//return csv_data;
	}, 
	load_into_collections: function(file_info, csv_data) {
		...
		var	file_props = csv_data.file_props;
		var file_data = csv_data.file_rows;
